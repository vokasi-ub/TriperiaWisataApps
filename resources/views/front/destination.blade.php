      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center" data-scrollax-parent="true">
          <div class="col-md-9 text-center ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
            ...
            <h1 class="mb-3 bread" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">Listing Wisata<br> {{$row2->namawilayah}}</h1>
          </div>
        </div>
      </div>
    </div>
		...
		<div class="container">
				<div class="row justify-content-start mb-5 pb-3">
						<div class="col-md-7 heading-section ftco-animate">
							...
							<h2 class="mb-4"><strong>Destination</strong> Wisata</h2>
						</div>
						<div class="col-md-12">
						    <p></p>
						</div>
					...
					<div class="row">	
						<div class="col-md-12 nav-link-wrap mb-5">
							...
							<div class="nav ftco-animate nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
								<a class="nav-link active" id="v-pills-whatwedo-tab" data-toggle="pill" href="#v-pills-whatwedo" role="tab" aria-controls="v-pills-whatwedo" aria-selected="true">{{$row->namawilayah}}</a>
							...
							<div class="tab-content ftco-animate" id="v-pills-tabContent" style="width: 100%;float: left;">
								...
								<div class="tab-pane fade show active" id="v-pills-whatwedo" role="tabpanel" aria-labelledby="v-pills-whatwedo-tab">
									<div class="row">
                                      @foreach ($listdestination as $rowpantai)
													...
													<div class="destination">
														...
														<div class="text p-3">
															...
															<p class="bottom-area d-flex">
																...
																<span class="ml-auto"><button class="btn btn-sm aqua-gradient"><i class="fa fa-search"></i> Lihat Detail</button></span></span>
															</p>
														</div>
